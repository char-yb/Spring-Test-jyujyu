...
public class StudentScoreServiceIntegrationTest extends IntegrationTest {
  ...
  public void savePassedStudentScoreTest() {
    ...
    // then
    List<ExamPassStudentResponse> passStudents =
        studentScoreService.getPassStudents(passed.getExam());
  ...
  public void saveFailedStudentScoreTest() {
    ...
    // then
    List<ExamFailStudentResponse> failedStudents =
        studentScoreService.getFailStudents(failed.getExam());
    ...
    Assertions.assertEquals(
        calculator
            ...
            .div(3.0)
            .getResult(),
        examFailStudentResponse.avgScore());
  }
}
