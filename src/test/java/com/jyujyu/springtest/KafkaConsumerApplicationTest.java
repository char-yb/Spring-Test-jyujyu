...
public class KafkaConsumerApplicationTest extends IntegrationTest {
  ...
  public void kafkaSendAndConsumeTest() {
    ...
    /**
     * kafkaProducerService에서 test-topic으로 expect-value라는 것을 넣어 호출을 했을 때, Template를 통해 Producer가
     * 호출되고, Producer가 Kafka에 메시지를 보낸다. 만약 kafkaConsumerService에서 listening 중인 Topic이 test-topic이라면,
